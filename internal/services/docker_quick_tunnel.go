// Package services provides functionality for managing Docker tunnels.
package services
...
// h, err := StartQuickTunnel(ctx, cli, "gdbase_net", "pgadmin", 80, 10*time.Second)
// if err != nil { /* lidar erro */ }
// gl.Log("info", "Cloudflare Tunnel URL: "+h.PublicURL)
