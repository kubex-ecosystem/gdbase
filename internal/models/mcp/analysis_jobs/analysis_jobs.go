...
type IAnalysisJob interface {
	...
	GetInputData() t.JSONB
	SetInputData(inputData t.JSONB)
	GetOutputData() t.JSONB
	SetOutputData(outputData t.JSONB)
...
type AnalysisJob struct {
	...
	InputData    t.JSONB    `json:"input_data" xml:"input_data" yaml:"input_data" gorm:"column:input_data;type:jsonb"`
	OutputData   t.JSONB    `json:"output_data" xml:"output_data" yaml:"output_data" gorm:"column:output_data;type:jsonb"`
...
func (a *AnalysisJob) GetInputData() t.JSONB                { return a.InputData }
...
func (a *AnalysisJob) GetMetadata() t.JSONB                 { return a.Metadata }
func (a *AnalysisJob) SetMetadata(metadata t.JSONB)         { a.Metadata = metadata }
