...
func (n *NotificationHistory) SetAnalysisJobID(analysisJobID *uuid.UUID)               { n.AnalysisJobID = analysisJobID }
func (n *NotificationHistory) GetPlatform() NotificationHistoryPlatform                { return n.Platform }
func (n *NotificationHistory) SetPlatform(platform NotificationHistoryPlatform)        { n.Platform = platform }
